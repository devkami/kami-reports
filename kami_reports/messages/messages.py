...
from kami_uno_database import get_qy_sellers_contact

from kami_reports.constant import SOURCE_DIR

messages_looger = logging.getLogger('messages_generator')
template_loader = FileSystemLoader(path.join(SOURCE_DIR, 'messages/templates'))
...
def get_sellers_contacts_from_database():
    contact_sellers = get_qy_sellers_contact()
